...
var AppContainer = function (_a) {
    ...
    return (React.createElement(Box, { style: siteStyle },
        React.createElement(Box, { style: headerStyle },
            React.createElement(Box, null, "Header"),
            React.createElement(Box, null,
                userInfo && "Hello, ".concat(userInfo.name, " "),
                React.createElement("a", { style: { cursor: "pointer", color: "blue", marginLeft: "10px" }, onClick: logout }, textsShort === null || textsShort === void 0 ? void 0 : textsShort.logout))),
        children));
};
...
var Login = function () {
    ...
    return (React.createElement(Box, { style: { textAlign: 'center', padding: '50px' } },
        React.createElement(Box, { style: { marginBottom: '20px' } },
            React.createElement(Input, { placeholder: textsShort === null || textsShort === void 0 ? void 0 : textsShort.loginName, onKeyUp: function (e) { return e.key === 'Enter' && login(); }, onChange: function (e) { return setUserName(e.target.value); } })),
        React.createElement(Box, null,
            React.createElement(Button, { onClick: login }, textsShort === null || textsShort === void 0 ? void 0 : textsShort.login))));
};
