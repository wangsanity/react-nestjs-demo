...
import React__default, { createContext, useContext, useDebugValue as useDebugValue$1 } from 'react';
import 'react-dom';
...
var h=React__default,n=shimExports;function p(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var q="function"===typeof Object.is?Object.is:p,r=n.useSyncExternalStore,t=h.useRef,u=h.useEffect,v=h.useMemo,w=h.useDebugValue;
...
var userKey = 'localUserInfo';
var getUserInfo = function () {
    var str = window.localStorage.getItem(userKey);
...
var previousPageKey = 'previousPage';
var savePreviousPage = function () {
...
var selectUser = function (state) { return state.user.userInfo || getUserInfo(); };
...
var langKey = 'lang';
var texts = function () {
    var lang = window.localStorage.getItem(langKey) || 'en-us';
    if (lang === 'zh-cn') {
        return {
...
var _a = texts(), short = _a.short, messages = _a.messages;
var initialState = {
    textsShort: short,
    messages: messages
};
var textsSlice = createSlice({
    ...
    reducers: {
        setTexts: function (state, action) {
...
textsSlice.actions.setTexts;
var selectTexts = function (state) { return state.texts; };
var textsReducer = textsSlice.reducer;
...
var rootReducer = createRootReducers();
configureStore({
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    reducer: rootReducer
});
var userAppSelector = useSelector;
...
var Button = function (_a) {
    ...
    return (React__default.createElement("button", __assign({ style: __assign(__assign(__assign({}, sharedStyles), defaultStyle), style) }, buttonProps), children));
};
...
var Input = function (_a) {
    ...
    return React__default.createElement("input", __assign({ style: __assign(__assign({}, defaultStyle), style) }, inputProps));
};
...
var Box = function (_a) {
    ...
    return (React__default.createElement("div", __assign({ style: __assign(__assign({}, defaultStyle), style) }, boxProps), children));
};
...
var AppContainer = function (_a) {
    ...
    var userInfo = userAppSelector(selectUser);
    var textsShort = userAppSelector(selectTexts).textsShort;
    var logout = function () {
    ...
    return (React__default.createElement(Box, { style: siteStyle },
        React__default.createElement(Box, { style: headerStyle },
            React__default.createElement(Box, null, "Header"),
            React__default.createElement(Box, null,
                userInfo && "Hello, ".concat(userInfo.name, " "),
                React__default.createElement("a", { style: { cursor: "pointer", color: "blue", marginLeft: "10px" }, onClick: logout }, textsShort === null || textsShort === void 0 ? void 0 : textsShort.logout))),
        children));
};
...
var Login = function () {
    ...
    var dispatch = useAppDispatch();
    var textsShort = userAppSelector(selectTexts).textsShort;
    var _a = React__default.useState(''), userName = _a[0], setUserName = _a[1];
    var login = function () {
        if (userName) {
            dispatch(setUser({
                name: userName,
    ...
    return (React__default.createElement(Box, { style: { textAlign: 'center', padding: '50px' } },
        React__default.createElement(Box, { style: { marginBottom: '20px' } },
            React__default.createElement(Input, { placeholder: textsShort === null || textsShort === void 0 ? void 0 : textsShort.loginName, onKeyUp: function (e) { return e.key === 'Enter' && login(); }, onChange: function (e) { return setUserName(e.target.value); } })),
        React__default.createElement(Box, null,
            React__default.createElement(Button, { onClick: login }, textsShort === null || textsShort === void 0 ? void 0 : textsShort.login))));
};
...
var Authentication = function (_a) {
    ...
    if (!userInfo) {
        savePreviousPage();
        return React__default.createElement(Login, null);
    }
    else {
...
export { AppContainer, Authentication, Login, selectUser, setUser, userReducer };
